...
async function openInSublimeText () {
    try {
        ...
        await open(gitPath, { app: 'Sublime Text' })
    }
    catch (err) {
        console.error(err)
...
function activate(context) {
    var disposable = vscode.commands.registerCommand('openInSublimeText.open', openInSublimeText)
